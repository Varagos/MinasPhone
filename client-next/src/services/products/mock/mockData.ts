...
export const mockProducts: Product[] = [
  ...
  },
  {
    ...
    description:
      '<p>Διπλή κάμερα 12MP προσφέρουν πληθώρα δυνατοτήτων άκομα και σε συνθήκες χαμηλού φωτισμού, ενώ η selfie 12MP υποστήριζει βίντεο 4Κ και slow motion.</p>',
    price: {
      raw: 598.73,
      formatted: '598.73',
    ...
    media: {
      type: 'image',
      source:
        'https://cdn.chec.io/merchants/30387/assets/RSXUxccWu0q111vq|xlarge_20190916100719_apple_iphone_11_64gb.jpeg',
  ...
  },
  {
    ...
    media: {
      type: 'image',
      source:
        'https://cdn.chec.io/merchants/30387/assets/dZbi4ast3SlG7U7Z|xlarsamsung_galaxy_tab_a7_2020_10_4_32gb_dark_grey.jpeg',
  ...
  },
  {
    ...
    media: {
      type: 'image',
      source:
        'https://cdn.chec.io/merchants/30387/assets/eHqWDleLN1oDxFgG|xlarge_20210402110211_xiaomi_poco_x3_pro_128gb_phantom_black.jpeg',
