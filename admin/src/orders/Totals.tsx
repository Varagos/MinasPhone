...
const Totals = () => {
  ...
  return (
    <Table sx={{ minWidth: '35em' }}>
      <TableBody>
        {/* <TableRow>
          <TableCell>{translate('resources.orders.fields.basket.sum')}</TableCell>
          <TableCellRight>
        ...
        <TableRow>
          <TableCell>{translate('resources.orders.fields.basket.delivery')}</TableCell>
          <TableCellRight>
        ...
        <TableRow>
          <TableCell sx={{ fontWeight: 'bold' }}>{translate('resources.orders.fields.basket.total')}</TableCell>
