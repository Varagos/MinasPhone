...
const LinkRouter = (props: any) => <Link {...props} style={{ textDecoration: 'none', color: 'inherit' }} passHref />;
...
const AppBreadcrumb = () => {
  ...
  const currentProductName = 'todo'; // useAppSelector((state) => state.product.data?.name);
